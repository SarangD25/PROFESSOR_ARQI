        ...
        {!org ? (
          <div className="bg-gray-800 p-6 rounded-lg mb-6">
            ...
            <form onSubmit={handleCreateOrg} className="flex gap-3">
              <input
                type="text"
                placeholder="Organization name (e.g., ABC Coaching Centre)"
                value={orgName}
          ...
          <>
            ...
            <div className="bg-gray-800 p-6 rounded-lg mb-6">
              ...
              <form onSubmit={handleAddStudents}>
                <textarea
                  ...
                  placeholder="John Doe, CS001, A&#10;Jane Smith, CS002, B&#10;Bob Johnson, CS003, A"
                  className="w-full p-3 rounded bg-gray-700 text-white h-40 font-mono text-sm mb-3"
                />
            ...
            {students?.length === 0 ? (
              <p className="text-gray-400 bg-gray-800 p-4 rounded">No students added yet.</p>
            ) : (
