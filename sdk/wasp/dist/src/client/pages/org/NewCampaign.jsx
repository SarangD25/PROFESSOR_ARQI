            ...
            <div className="card card-glow" style={{ marginBottom: '20px' }}>
              ...
              <div className="form-group">
                ...
                <div style={{ display: 'flex', gap: '10px', marginTop: '4px' }}>
                  {['easy', 'medium', 'hard'].map(d => (<button key={d} type="button" onClick={() => setForm({ ...form, difficulty: d })} className={`diff-btn${form.difficulty === d ? (d === 'easy' ? ' selected-easy' : d === 'hard' ? ' selected-hard' : ' selected-med') : ''}`}>
...
//# sourceMappingURL=NewCampaign.jsx.map