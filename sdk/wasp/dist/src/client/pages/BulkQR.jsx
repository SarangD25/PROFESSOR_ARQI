...
export function BulkQR() {
    ...
    return (<div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        {qrResults.length === 0 ? (<div className="bg-gray-800 p-6 rounded-lg print:hidden">
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2">Select Campaign</label>
              <select value={selectedCampaign} onChange={e => setSelectedCampaign(e.target.value)} className="w-full p-2 rounded bg-gray-700 text-white">
            ...
            <button onClick={handleGenerate} disabled={!selectedCampaign || generating} className="bg-green-600 hover:bg-green-700 px-6 py-3 rounded-lg disabled:opacity-50 font-bold">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {qrResults.map((r, i) => (<div key={i} className="bg-white text-black p-4 rounded-lg text-center">
