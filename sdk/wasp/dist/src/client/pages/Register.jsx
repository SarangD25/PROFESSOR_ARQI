    ...
    return (<div className="auth-wrap">
      ...
      <div className="auth-right">
        <div className="auth-form-box animate-in">
          ...
          {error && (<div style={{ padding: '10px 14px', borderRadius: '8px', marginBottom: '16px', fontSize: '13px',
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn btn-primary" disabled={loading} style={{ width: '100%', justifyContent: 'center', padding: '13px', marginTop: '8px', opacity: loading ? 0.7 : 1 }}>
